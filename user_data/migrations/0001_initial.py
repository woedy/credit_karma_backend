    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drivers_licence', models.CharField(blank=True, max_length=100, null=True)),
                ('social_security', models.CharField(blank=True, max_length=100, null=True)),
                ('passport_number', models.CharField(blank=True, max_length=100, null=True)),
                ('mothers_median_name', models.CharField(blank=True, max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_data.client')),
            ],
        ),
        migrations.CreateModel(
            name='BankInfo',
